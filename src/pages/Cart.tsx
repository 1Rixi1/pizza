...
import { clearItems, selectCart } from '../redux/slices/cartSlice'
 ...
 const Cart: React.FC = () => {
  ...
  const countPizza = items.reduce((sum: number, obj: any) => obj.count + sum, 0)
      ...
      <div className="cart">
        <div className="cart__top">
          <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Корзина</h2>
          <div onClick={clerPizzas} className="cart__clear">
        ...
        <div className="content__items">
          ...
          {
            items.map((pizza: any) => <CartItem {...pizza} key={pizza.id} />)
          }
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span> Всего пицц: <b>{countPizza} шт.</b> </span>
